...
export const createMockSurface = (): Surface => ({
  _type: "Surface",
  flush: vi.fn(),
  dispose: vi.fn(),
  delete: vi.fn(),
...
export const createMockPaint = (): Paint => ({
  _type: "Paint",
  setColor: vi.fn(),
  setStyle: vi.fn(),
...
export const createMockPath = (): Path => ({
  _type: "Path",
  moveTo: vi.fn(),
  lineTo: vi.fn(),
  cubicTo: vi.fn(),
...
export const createMockImage = (): Image => ({
  _type: "Image",
  delete: vi.fn(),
  width: vi.fn(() => 100),
  height: vi.fn(() => 100),
...
export const createMockShader = (): Shader => ({
  _type: "Shader",
  delete: vi.fn(),
  deleteLater: vi.fn(),
  isAliasOf: vi.fn(),
...
export const createMockColorFilter = (): ColorFilter => ({
  _type: "ColorFilter",
  delete: vi.fn(),
  deleteLater: vi.fn(),
  isAliasOf: vi.fn(),
...
export const createMockImageFilter = (): ImageFilter => ({
  _type: "ImageFilter",
  delete: vi.fn(),
  deleteLater: vi.fn(),
  isAliasOf: vi.fn(),
...
export const createMockTextBlob = (): TextBlob => ({
  _type: "TextBlob",
  delete: vi.fn(),
  deleteLater: vi.fn(),
  isAliasOf: vi.fn(),
...
export const createMockTypeface = (): Typeface => ({
  _type: "Typeface",
  delete: vi.fn(),
  getGlyphIDs: vi.fn(),
...
export const createMockFont = (): Font => ({
  _type: "Font",
  delete: vi.fn(),
  deleteLater: vi.fn(),
  isAliasOf: vi.fn(),
...
export const createMockCanvasKit = (): CanvasKit => ({
  ...
  ColorAsInt: vi.fn((r, g, b, a = 255) => (a << 24) | (r << 16) | (g << 8) | b),
