...
const createMockPaint = vi.fn().mockImplementation(
  (): Paint => ({
    _type: "Paint",
    setColor: vi.fn(),
    setStyle: vi.fn(),
...
const createMockPath = vi.fn().mockImplementation(
  (): Path => ({
    _type: "Path",
    moveTo: vi.fn(),
    lineTo: vi.fn(),
...
const createMockImage = vi.fn().mockImplementation(
  (): Image => ({
    _type: "Image",
    delete: vi.fn(),
    width: vi.fn(() => 100),
...
const createMockShader = vi.fn().mockImplementation(
  (): Shader => ({
    _type: "Shader",
    delete: vi.fn(),
    deleteLater: vi.fn(),
...
const createMockColorFilter = vi.fn().mockImplementation(
  (): ColorFilter => ({
    _type: "ColorFilter",
    delete: vi.fn(),
    deleteLater: vi.fn(),
...
const createMockImageFilter = vi.fn().mockImplementation(
  (): ImageFilter => ({
    _type: "ImageFilter",
    delete: vi.fn(),
    deleteLater: vi.fn(),
...
const createMockTextBlob = vi.fn().mockImplementation(
  (): TextBlob => ({
    _type: "TextBlob",
    delete: vi.fn(),
    deleteLater: vi.fn(),
...
const createMockTypeface = vi.fn().mockImplementation(
  (): Typeface => ({
    _type: "Typeface",
    delete: vi.fn(),
    getGlyphIDs: vi.fn(),
...
const createMockFont = vi.fn().mockImplementation(
  (): Font => ({
    _type: "Font",
    delete: vi.fn(),
    deleteLater: vi.fn(),
...
export const createMockCanvasKit = vi.fn().mockImplementation(
  (): CanvasKit => ({
    ...
    Path: {
      ...
      MakeFromCmds: createMockPath,
      MakeFromOp: createMockPath,
      MakeFromPathInterpolation: createMockPath,
      MakeFromSVGString: createMockPath,
      MakeFromVerbsPointsWeights: createMockPath,
