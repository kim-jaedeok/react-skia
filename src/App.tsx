        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(350px, 1fr))', gap: '20px' }}>
          ...
          <div>
            ...
            <SkiaCanvas width={350} height={200}>
              ...
              >
                <Rect x={10} y={20} width={150} height={40} color="#FFF" />
              </LinearGradient>
              ...
              >
                <Circle cx={235} cy={40} r={35} color="#FFF" />
              </RadialGradient>

              <Text x={10} y={90} text="Linear & Radial Gradients" fontSize={14} color="#666" />
              ...
              >
                <Rect x={10} y={110} width={80} height={50} color="#FFF" />
              </LinearGradient>
              ...
              >
                <Rect x={120} y={110} width={80} height={50} color="#FFF" />
              </LinearGradient>

              <Text x={10} y={185} text="CSS와 동일한 그라디언트 API" fontSize={12} color="#999" />
            </SkiaCanvas>
          </div>
